...
<center>
<div id="tampil">   
 <h3 align='center'>LAPORAN PENGELUARAN KAS KECIL</h3>
...
<div id='tampil'>
   <?php // jika submit button diklik
    ...
    //query
    $sql1 = "select * from pengeluaran_kk where month(tgl_pengeluaran)='$bulan' 
    and year(tgl_pengeluaran) = '$tahun' order by tgl_pengeluaran asc";
    ...
    echo "<form method='POST' action='pengeluaran-cetak.php' enctype='multipart/form-data' target='_blank'>";
    ...
    while($data = mysqli_fetch_assoc($hasil1)){
      ...
      echo "<td width='18%' align='center' style='font:20px verdana'>".$data['tgl_pengeluaran']."</td>"
        ."<td width='8%' align='center' style='font:20px verdana'>".$data['no_pengeluaran']."</td>"
        ."<td width='10%' align='center' style='font:20px verdana'>".$data['no_biaya']."</td>"
        ."<td>".$data['nm_pengeluaran']."</td>"
        ."<td width='25%' align='right'>".number_format($data['jml_pengeluaran'])."</td>";
      echo "</tr>";
